...
export const listSchemaDataMedia = [
	...
	{ name: 'banner_text_card_title_six', description: 'Título do Banner principal do hub em que o próximo sorteio já tenha sido realizado.', value: 'O Prêmio já saiu!', tag: 'banner', type: typesMedia[0] },
	...
	{ name: 'banner_text_card_subtitle_four', description: 'Subtitulo do banner dentro do Banner principal em que o próximo sorteio já tenha sido realizado.', value: 'Quer saber se você foi o sortudo? É só tocar pra revelar!', tag: 'banner', type: typesMedia[0] },
	{
	...
	},
	{
		...
		description: 'texto de (clique de redirecionamento) no botão do banner principal quando um sorteio já foi realizado.',
		value: 'Revelar agora',
		tag: 'banner',
		type: typesMedia[0],
	},
	...
	{ name: 'colors_text_button', description: 'Cor do texto interno do botão', value: '#FFFFFF', tag: 'colors', type: typesMedia[2] },
	...
	{ name: 'colors_border_two', description: 'Cor da borda do separador utilizado entre seções', value: '#FFBE00', tag: 'colors', type: typesMedia[2] },
