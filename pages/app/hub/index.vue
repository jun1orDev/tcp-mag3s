	...
	<div class="pt-12 min-h-screen flex flex-col justify-between">
		...
		<UContainer>
			...
			<div class="grid grid-cols-1 lg:grid-cols-2 items-center lg:gap-3">
				<!-- Banner Principal -->
				<BannerCard linkSource="" :hasImageDetach="true" :imageDetach="app.banner_image_card_one"
			...
			<div class="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-2 items-start lg:items-center gap-1 lg:gap-3">
				<!-- Banner Destacado -->
				<BannerCard3 class="" linkSource="/app/meus-premios" :imageDetach="app.banner_image_card_three"
					:description="app.banner_text_card_description_three" />

				<!-- Banners Duplos -->
				<div class="grid grid-cols-2 gap-4 md:gap-5 lg:row-start-1 lg:row-span-2">
					<!-- Lado Esquerdo -->
					<BannerCard4 linkSource="/app/revelar-premio" :background="app.banner_background_card_three"
					...
					<!-- Lado Direito -->
					<BannerCard4 linkSource="" :background="app.banner_background_card_four"
						:title="app.banner_text_card_title_four" countdown="2023-11-15T00:00:00+0000" :callToAction="false"
						:awards="[0, 1]" :carouselAutoPlay="5000" />
				</div>

				<!-- Banner Blog -->
				<BannerCard5 class="" :linkSource="app.banner_link_external_card_one" :imageDetach="app.banner_image_card_four"
					:description="app.banner_text_card_description_four" />
			</div>
		</UContainer>
