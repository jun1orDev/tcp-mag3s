<template>
  <div class="fm2 rounded-xl p-4" :style="[colorBackground, colorText]">
    <div class="fm3 flex justify-end items-center md:translate-x-8">
      <p class="tracking-tighter text-7xl md:text-[4.9rem] translate-x-3.5 md:translate-x-4 -translate-y-2">2x</p>
      <p class="uppercase text-xl md:text-1xl bg-green-600 ps-5 pe-2 md:pe-8 py-1 md:py-1.5 rounded-e-xl">Super Oferta!</p>
    </div>
    <div>
      <p>Receba o <strong>DOBRO</strong> de raspadinhas e o <strong>DOBRO</strong> de números da sorte por um adicional de apenas <strong>R$4,90</strong>!</p>
    </div>
    <div>
      Sim, eu quero!
    </div>
