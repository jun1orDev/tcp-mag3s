  ...
  <div class="pt-12 pb-32 lg:pb-32 fm1" :style="[bgColor, colorText]">
    <UContainer class="">
      ...
      <div class="flex flex-col items-center">
        <div class="w-8 h-8 flex justify-center items-center rounded-full cursor-pointer" :style="[colorButton, colorTextButton]">
      ...
      <div class="md:flex lg:flex-col justify-between items-center lg:m-auto lg:w-8/12 mt-12">
        ...
        <ul
          ...
          <li v-for="(item, index) in menu" :class="`${index + 1 >= menu.length ? 'mb-0' : 'mb-4'}`">
